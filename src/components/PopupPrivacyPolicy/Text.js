...
export default function Text(props) {
  return (
    <div>
      <h4 className={styles["p-title"]}>1. Общие положения</h4>
      ...
      <p className={styles["paragraph"]}>3.1. Фамилия, имя, отчество;</p>
      <p className={styles["paragraph"]}>3.2. Номер телефона;</p>
      <p className={styles["paragraph"]}>3.3. Адрес электронной почты;</p>
      <p className={styles["paragraph"]}>
      ...
      <p className={styles["paragraph"]}>
        ...
        содержащимся на веб-сайте httpsː//thismywebsite·com; уточнение деталей
        заказа.
      </p>
      <p className={styles["paragraph"]}>
        ...
        почты privacy@thismywebsite·com с пометкой «Отказ от уведомлений о новых
      ...
      <p className={styles["paragraph"]}>
        ...
        специальные формы, расположенные на сайте httpsː//thismywebsite·com.
      ...
      <p className={styles["paragraph"]}>
        ...
        privacy@thismywebsite·com с пометкой «Отзыв согласия на обработку
        персональных данных».
      </p>
      <h4 className={styles["p-title"]}>
      ...
      <h4 className={styles["p-title"]}>8. Заключительные положения</h4>
      <p className={styles["paragraph"]}>
        ...
        Оператору с помощью электронной почты privacy@thismywebsite·com.
      </p>
      <p className={styles["paragraph"]}>
      ...
      <p className={styles["paragraph"]}>
        ...
        Интернет по адресу httpsː//thismywebsite·com/privacy/.
      </p>
    </div>
  );
}
